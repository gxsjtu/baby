        ...
        if (option == 'census') {
            ...
            this.setData({
                ...
                },
                {
                    title: '所需材料：',
                    items: [
                        '本市户口所需材料：本市户籍人员须持父亲（或母亲）的本市户口簿及本人的户口簿（或港澳台通行证等身份证明）、2016年度居保参保凭证，到父亲（或母亲）户籍所在地的收费医院办理缴费手续。',
                        '外市户口所需材料：凭父母有效期内的《上海市居住证》，以及由本市医疗机构签发的《出生医学证明》、户口簿，到父母居住证所在地的收费医院办理缴费手续。'
                    ]
                },
                {
                    title: '收费标准：',
